...
|---|---|---|
| chrome-devtools-mcp | https://github.com/ChromeDevTools/chrome-devtools-mcp | MCP server que da acesso ao Chrome DevTools (debug, performance, network) pro agente de IA. |
